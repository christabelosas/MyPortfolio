...
<body>
    ...
    <div>
        <img src="https://i.imgur.com/hIVTcwS.jpeg" class="logos small-image" alt="Portrait of Christabel">
    </div>
    <h1 class="justify">About Me</h1>
    <p class="p-3 mb-2 bg-info text-white"><em>
        Hello! I’m Christabel, a passionate data scientist based in Manchester. I hold a Master’s degree in Data Science from the University of Salford, graduating with distinction, and a Second Class Upper Division Bachelor’s degree in Agricultural Economics from the University of Benin.
    </em></p>
    <p class="p-3 mb-2 bg-info text-white"><em>
        With my experience and educational background, my expertise spans data visualization (Power BI, Excel, Tableau), data manipulation (MySQL, PostgreSQL, Python, R), machine learning (TensorFlow, SciKit Learn), and cloud computing (AWS, GCP, Azure).
    </em></p>
    <p class="p-3 mb-2 bg-info text-white"><em>
        I thrive in collaborative environments and am dedicated to leveraging data to drive informed decisions and deliver measurable results. Explore my portfolio to see the impactful projects I’ve worked on.
    </em></p>
    <h1 class="justify"> Education</h1>
<p>
Msc: Data Science 	 01/2023 – 03/2024 
<br>University of Salford - Manchester, United Kingdom - Distinction</p>
<p>
Bachelor of Science: Agricultural Economics and Extension Services 	 02/2011 – 05/2016 
<br>University of Benin - Benin City - Second Class Upper, GPA: 4.1</p>
...
<p><b>Machine learning Modelling:</b>
...
<footer>
    <p><b>&copy; 2024 My Data Science Portfolio. All rights reserved.</b></p>
  </footer>
